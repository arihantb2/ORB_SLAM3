...
LocalMappingVisualizationPublisher::LocalMappingVisualizationPublisher(const rclcpp::Node::SharedPtr& node,
                                                                       const std::string& map_frame_id)
    : node_(node), map_frame_id_(map_frame_id)
{
...
void LocalMappingVisualizationPublisher::publish_batch(const std::vector<ORB_SLAM3::LocalMappingResult>& batch,
...
void LocalMappingVisualizationPublisher::reset()
{
    map_points_.clear();
...
void LocalMappingVisualizationPublisher::update_state_from_result(const ORB_SLAM3::LocalMappingResult& result)
{
...
sensor_msgs::msg::PointCloud2 LocalMappingVisualizationPublisher::make_point_cloud(
    const std::vector<Eigen::Vector3f>& points, const rclcpp::Time& stamp) const
{
...
void LocalMappingVisualizationPublisher::publish_visualization(const rclcpp::Time& stamp)
{
