                                       ...
                                       vector<MapPoint*>& vpNonCorrectedMPs)
{
    ...
    for (MapPoint* pMPi : vpNonCorrectedMPs)
    {
        ...
        {
            Verbose::Print(Verbose::VERBOSITY_DEBUG) << "ERROR: MapPoint has a reference KF from another map" << endl;
        }
    }
}
                                ...
                                int& num_MPs, int& num_edges, bool bLarge, bool bRecInit)
{
    ...
    for (int i = 0; i < N; i++)
    {
        ...
        if (!pKFi->mPrevKF)
        {
            Verbose::Print(Verbose::VERBOSITY_DEBUG) << "NOT INERTIAL LINK TO PREVIOUS FRAME!!!!" << endl;
            continue;
        }
        ...
        {
            Verbose::Print(Verbose::VERBOSITY_DEBUG) << "ERROR building inertial edge" << endl;
        }
    }
    ...
    {
        Verbose::Print(Verbose::VERBOSITY_DEBUG) << "FAIL LOCAL-INERTIAL BA!!!!" << endl;
        return;
    }
